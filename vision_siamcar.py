        ...
        if cap_flag == 1:
            ...
            while (cap.isOpened()):
                ...
                if track_flag == 1:
                    ...
                    # 跟踪目标并获取边界框
                    outputs = tracker.track(search_img, hp)
...
#     img_input.save(f"output_camera/{filename}")
#
#     # img_input.save("output_camera/image.png")
#
...
def load_model():
    ...
    parser.add_argument('--config', type=str, default='./siamcar/experiments/siamcar_r50/config.yaml', help='config file')
...
if __name__ == '__main__':
    ...
    label_track_model_name_1 = tk.Label(window, text="SiamCAR", font=("Microsoft YaHei", 15, "bold"),fg="red")
